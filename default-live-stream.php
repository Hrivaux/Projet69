                ...
                <div class="middle-sidebar-left pe-0 ms-0 me-0" style="max-width: 100%;">
                    <div class="row">
                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                            <div class="card border-0 mb-0 rounded-3 overflow-hidden chat-wrapper bg-image-center bg-image-cover" style="background-image: url(https://via.placeholder.com/1280x850.png);">
                                <div class="card-body position-absolute mt-0 ms-0 left-0">
                                    <img src="https://via.placeholder.com/150x200.png" alt="image" class="w150 h200 rounded-3 position-relative z-index-1 shadow-xss">
                                </div>
