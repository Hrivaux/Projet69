                                ...
                                <div class="col-lg-6 col-xl-4 col-md-6 mb-2 mt-2 pe-2">
                                    <div class="card p-0 bg-white rounded-3 shadow-xs border-0">
                                        <div class="card-body p-3 border-top-lg border-size-lg border-primary p-0">
                                            <h4><span class="font-xsss fw-700 text-grey-900 mt-2 d-inline-block text-dark">To Do </span><a href="#" class="float-right btn-round-sm bg-greylight" data-toggle="modal" data-target="#Modaltodo"><i class="feather-plus font-xss text-grey-900"></i></a></h4>
                                        </div>
                                        ...
                                        <div class="card-body p-3 bg-lightblue theme-dark-bg mt-0 mb-3 ms-3 me-3 rounded-3">
                                            <img src="https://via.placeholder.com/450x350.png" alt="image" class="img-fluid mb-3 p-2">
                                ...
                                <div class="col-lg-6 col-xl-4 col-md-6 mb-2 mt-2 pe-2 ps-2">
                                    <div class="card p-0 bg-white rounded-3 shadow-xs border-0">
                                        <div class="card-body p-3 border-top-lg border-size-lg border-warning p-0">
                                            <h4><span class="font-xsss fw-700 text-grey-900 mt-2 d-inline-block text-dark">In progress </span><a href="#" class="float-right btn-round-sm bg-greylight" data-toggle="modal" data-target="#Modaltodo"><i class="feather-plus font-xss text-grey-900"></i></a></h4>
                                        </div>
                                        <div class="card-body p-3 bg-lightblue theme-dark-bg mt-0 mb-3 ms-3 me-3 rounded-3">
                                        ...
                                        <div class="card-body p-3 bg-lightbrown theme-dark-bg mt-0 mb-3 ms-3 me-3 rounded-3">
                                            <img src="https://via.placeholder.com/450x350.png" alt="image" class="img-fluid mb-3 rounded-3">
                                ...
                                <div class="col-lg-6 col-xl-4 col-md-6 mb-2 mt-2 ps-2">
                                    <div class="card p-0 bg-white rounded-3 shadow-xs border-0">
                                        <div class="card-body p-3 border-top-lg border-size-lg border-success p-0">
                                            <h4><span class="font-xsss fw-700 text-grey-900 mt-2 d-inline-block text-dark">Done </span><a href="#" class="float-right btn-round-sm bg-greylight" data-toggle="modal" data-target="#Modaltodo"><i class="feather-plus font-xss text-grey-900"></i></a></h4>
                                        </div>
                                        <div class="card-body p-3 bg-lightblue theme-dark-bg mt-0 mb-3 ms-3 me-3 rounded-3">
                                            <h4 class="font-xsss fw-700 text-grey-900 mb-2 mt-1 d-block">Laravel Product Design</h4>
                                            <p class="font-xssss lh-24 fw-500 text-grey-500 mt-3 d-block mb-3">Visit Home Depot to find out what is needed to rebuild backyard patio.</p>
