                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card w-100 border-0 shadow-none p-5 rounded-xxl bg-lightblue2 mb-3">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <img src="https://via.placeholder.com/450x300.png" alt="image" class="w-100">
                                            </div>
                                                ...
                                                <div class="card-body p-2 border-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8 ps-0">
                                                            <h4 class="font-xsss d-block fw-700 mt-2 mb-0">Advanced Python Sass <span class="float-right mt-1 font-xsssss text-grey-500">87%</span></h4>
                                                            <p class="font-xssss fw-600 text-grey-500 lh-26">Designer</p>
                                                        </div>
                                                    </div>
                                                </div>
